...
class RESTAuth(AuthBase):
    ...
    def __call__(self, request):
        ...
        message = timestamp + request.method + urlparse(request.path_url).path + str(request.body or '')
...
class TruexRESTClient(object):
    ...
    def __Request(self, method, url, body=None, query=None, timeout=None):
        ...
        try:
            ...
            request = requests.Request(method, url, data=body, auth=self.auth, params=query)
