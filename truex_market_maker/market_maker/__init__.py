...
def run():
    parser = argparse.ArgumentParser(description='sample TrueX market maker')
    parser.add_argument('command', nargs='?', help='Instrument symbol on TrueX or "setup" for first-time config')
